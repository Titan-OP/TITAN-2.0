# COPYRIGHT (C) 2021 BY тє¢нησ_ρяσ
# MADE BY тє¢нησ_ρяσ AND KANEKIᶠᶠ ✓
# MADE FOR TITAN 2.0
# FULL CREDITS тє¢нησ_ρяσ|KANEKIᶠᶠ ✓ and TEAM LEGEND🔥🔥🔥
...
import heroku3
from TITAN import OWNER_ID, telethn as update


UPSTREAM_REPO_URL = "https://github.com/Techno212/TITAN-2.0"
...
async def upstream(ups):
    ...
    if HEROKU_API_KEY is not None:
        ...
        await lol.edit(
            "`[Updater]\
                        Your bot is being updated, please wait for it to get complete.\nIt may take upto 5 minutes `"
        )
        ups_rem.fetch(ac_br)
