...
import TITAN.modules.sql.notes_sql as sql
from TITAN import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from TITAN.__main__ import DATA_IMPORT
from TITAN.modules.helper_funcs.chat_status import user_admin
from TITAN.modules.helper_funcs.alternate import typing_action

# from TITAN.modules.rules import get_rules
import TITAN.modules.sql.rules_sql as rulessql

# from TITAN.modules.sql import warns_sql as warnssql
import TITAN.modules.sql.blacklist_sql as blacklistsql
from TITAN.modules.sql import disable_sql as disabledsql

# from TITAN.modules.sql import cust_filters_sql as filtersql
# import TITAN.modules.sql.welcome_sql as welcsql
import TITAN.modules.sql.locks_sql as locksql
from TITAN.modules.connection import connected
...
def import_data(update, context):
    ...
    if msg.reply_to_message and msg.reply_to_message.document:
        ...
        try:
            ...
            msg.reply_text(
                f"An error occurred while recovering your data. The process failed. If you experience a problem with this, please take it to @TITANX_CHAT"
            )
