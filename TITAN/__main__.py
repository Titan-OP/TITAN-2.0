...
from TITAN.modules import ALL_MODULES
from TITAN.modules.helper_funcs.alternate import typing_action
from TITAN.modules.helper_funcs.chat_status import is_user_admin
from TITAN.modules.helper_funcs.misc import paginate_modules
from TITAN.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
Hello there, I'm [TITAN 2.0](https://telegra.ph/file/b3848003d589bdbd971f3.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add TITAN BOT to your group 💫",
            url="t.me/Titan1v0_bot?startgroup=true",
        ),
    ],
]
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("TITAN.modules." + module_name)
...
@run_async
def TITAN_about_callback(update, context):
    query = update.callback_query
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        TITAN_about_callback, pattern=r"aboutmanu_"
    )
    ...
    if тє¢нησ_ρяσ == 1097093376:
         print ("тє¢нησ_ρяσ ADDED SIR ")
    else:
